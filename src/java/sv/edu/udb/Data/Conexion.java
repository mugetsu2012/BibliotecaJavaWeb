...
public class Conexion {
    ...
    public Conexion() throws SQLException {
        try {
            ...
            conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/bibliotecajava?useSSL=false&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC", "root", "123456");
